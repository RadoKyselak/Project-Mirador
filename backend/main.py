...
async def analyze_claim_for_api_plan(claim: str) -> Dict[str, Any]:
    prompt = (
        ...
        '{ "claim_normalized": \"...\", "claim_type": \"quantitative\", "api_plan": { "tier1_params": { "bea": {\"DataSetName\":\"NIPA\",\"TableName\":\"T31600\",\"Frequency\":\"A\",\"Year\":\"2023\",\"LineCode\":[\"2\",\"14\"]}, \"census\": null }, \"tier2_keywords\": [\"...\",\"...\"] } }\n"
    )
    try:
